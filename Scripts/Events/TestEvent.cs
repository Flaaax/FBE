...
// {
//     // 背景图位置
//     public override string CustomInitialPortraitPath => "res://FBE/images/events/WaitForGodot.png";
//
//     // 设置一些数值
//     protected override IEnumerable<DynamicVar> CanonicalVars =>
//     [
//         new DamageVar(7m, ValueProp.Unblockable | ValueProp.Unpowered),
//         new GoldVar(60)
//     ];
//
//     // 什么时候会遇到。这里的条件是所有玩家的金币都大于等于60
//     public override bool IsAllowed(IRunState runState) =>
//         (runState.Players.All(p => p.Gold >= DynamicVars.Gold.BaseValue)) && false;
//
